            ...
            <div className="row">
              <div className="col-xl-12">
                <div className="bradcam_text text-center">
                  <h3>blog</h3>
                  <p>Discover Essaouira's beauty and soul ...</p>
                </div>
              </div>
            </div>
          </div>
                  ...
                  <article className="blog_item">
                    <div className="blog_item_img">
                      <img
                        ...
                        alt=""
                      />
                      <a href="/home" className="blog_item_date">
                        <h3>15</h3>
                        <p>Jan</p>
                      </a>
                    </div>
                  ...
                  <nav className="blog-pagination justify-content-center d-flex">
                    <ul className="pagination">
                      <li className="page-item">
                        <a href="/home" className="page-link" aria-label="Previous">
                      ...
                      <li className="page-item">
                        <a href="/home" className="page-link" aria-label="Next">
